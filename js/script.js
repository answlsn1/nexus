...
$(document).ready(function () {
    ...
    $('.visual-story').waypoint(function (dir) {
        if (dir == "down") {
            $('.visual-story').addClass('contents-1-active');
        }
    }, {
        offset: '80%'
    });
    ...
    $('.contents-2').waypoint(function (dir) {
        if (dir == "down") {
            $('.contents-2').addClass('contents-1-active');
        }
    }, {
        offset: '80%'
    });
    ...
    $('.contents-3').waypoint(function (dir) {
        if (dir == "down") {
            $('.contents-3').addClass('contents-1-active');
        }
    }, {
        offset: '80%'
    });
    ...
    $('.contents-4').waypoint(function (dir) {
        if (dir == "down") {
            $('.contents-4').addClass('contents-1-active');
        }
    }, {
        offset: '80%'
    });
    ...
    $('.contents-5').waypoint(function (dir) {
        if (dir == "down") {
            $('.contents-5').addClass('contents-1-active');
        }
    }, {
        offset: '80%'
    });
    ...
    $('.contents-6').waypoint(function (dir) {
        if (dir == "down") {
            $('.contents-6').addClass('contents-1-active');
        }
    }, {
        offset: '80%'
    });
    ...
    $('.contents-7').waypoint(function (dir) {
        if (dir == "down") {
            $('.contents-7').addClass('contents-1-active');
        }
    }, {
        offset: '80%'
    });
    ...
    $('.contents-8').waypoint(function (dir) {
        if (dir == "down") {
            $('.contents-8').addClass('contents-1-active');
        }
    }, {
        offset: '80%'
    });
